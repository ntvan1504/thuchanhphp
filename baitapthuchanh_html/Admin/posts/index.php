...
$listPost = $post->buildQueryParams([
            "select" => "posts.id, posts.name, posts.description, posts.created_time, categories.name as cate_name", //chỉ lấy một số cột cần đến, đổi tên nếu trùng tên
            "join" => "INNER JOIN categories ON categories.id = posts.cate_id" //inner join 2 bảng bằng liên kết của khóa ngoại
        ])->select(); //phải truyền $param dạng mảng vào hàm buildQueryParams
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- /.table-responsive -->
                            <a class="btn btn-lg btn-success btn-block" href="<?= $router->createUrl("posts/detail") ?>">Add new</a>
