...
if ($id && $router->getPOST("submit")){
    if ($u->delete("id=$id",['id'=>$id])){ //dùng primary key để thực hiện delete
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Xóa <?=$uDetail ["username"] ?></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6" class="show-data">
                                        <form role="form" action="<?php echo $router->createUrl('users/delete',["id" => $id]) ?>" method="POST">
