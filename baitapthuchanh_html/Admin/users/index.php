...
$query = $u->buildQueryParams([])->select(); //phải truyền $param dạng mảng vào hàm buildQueryParams
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                ...
                                <table width="100%" class="table">
                                    ...
                                    <tbody>
                                        <?php foreach($query as $row){?>
                                            <tr>
                                                <td><?= $row['id'] ?></td>
                                                <td><a href="<?= $router->createUrl("users/detail", ["id"=> $row["id"]]) ?>"><?= $row['username'] ?></a></td>
                                                <td><?= $row["password"] ?></td>
                            ...
                            <!-- /.table-responsive -->
                            <a class="btn btn-lg btn-success btn-block" href="<?= $router->createUrl("users/detail") ?>">Add new</a>
